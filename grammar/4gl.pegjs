...
globals
  = b:(GLOBALS SPACE (define / SPACE / comment)* END SPACE GLOBALS SPACE) {
      return addGlobal(b);
    }

function
  = MAIN SPACE b:blockCommand? END SPACE MAIN SPACE { return addMain(b); }
  / FUNCTION
    SPACE
    i:ID
    p:parameterList
    ...
    SPACE
    FUNCTION
    SPACE { return addFunction(i, p, b); }

blockCommand = c:commands+
...
ID = id:$([a-zA-Z_] [a-zA-Z0-9_]*) { return addId(id); }

DEFINE = k:"define"i { return addKeyword(k); }

CALL = k:"call"i { return addKeyword(k); }

DISPLAY = k:"display"i { return addKeyword(k); }

END = k:"end"i { return addKeyword(k); }

FUNCTION = k:"function"i { return addKeyword(k); }
...
STRING = k:"string"i { return addKeyword(k); }

RETURNING = k:"returning"i { return addKeyword(k); }

OPERATOR = o:[~!@%^&*-+|/{}\:;<>?#_] { addOperator(o); }

EQUAL = o:"=" { addOperator(o); }

O_PARENTHESIS = o:"(" { addOperator(o); }

C_PARENTHESIS = o:")" { addOperator(o); }

O_BRACKET = o:"[" { addOperator(o); }

C_BRACKET = o:"]" { addOperator(o); }

AT = o:"@" { addOperator(o); }

DOT = o:"." { addOperator(o); }

COLON = o:":" { addOperator(o); }

COMMA = o:"," { addOperator(o); }

ASTERISK = o:"*" { addOperator(o); }

ARRAY = k:"array"i { return addKeyword(k); }

BIGINT = k:"bigint"i { return addKeyword(k); }

BYTE = k:"byte"i { return addKeyword(k); }

CHAR = k:"CHAR"i { return addKeyword(k); }

CHARACTER = k:"character"i { return addKeyword(k); }

DATE = k:"date"i { return addKeyword(k); }

DATETIME = k:"datetime"i { return addKeyword(k); }

DEC = k:"dec"i { return addKeyword(k); }

DECIMAL = k:"decimal"i { return addKeyword(k); }

DOUBLE_PRECISION = k:$("double"i SPACE "precision"i) { return addKeyword(k); }

DYNAMIC_ARRAY = k:$("dynamic"i SPACE "array"i) { return addKeyword(k); }

FLOAT = k:"float"i { return addKeyword(k); }

INT = k:"int"i { return addKeyword(k); }

INTEGER = k:"integer"i { return addKeyword(k); }

INTERVAL = k:"interval"i { return addKeyword(k); }

LIKE = k:"like"i { return addKeyword(k); }

MONEY = k:"money"i { return addKeyword(k); }

NCHAR = k:"nchar"i { return addKeyword(k); }

NUMERIC = k:"numeric"i { return addKeyword(k); }

NVARCHAR = k:"nvarchar"i { return addKeyword(k); }
...
SMALLFLOAT = k:"smallfloat"i { return addKeyword(k); }

SMALLINT = k:"smallint"i { return addKeyword(k); }

TEXT = k:"text"i { return addKeyword(k); }

TO = k:"to"i { return addKeyword(k); }

VARCHAR = k:"varchar"i { return addKeyword(k); }

YEAR = k:"year"i { return addKeyword(k); }

MONTH = k:"month"i { return addKeyword(k); }

DAY = k:"day"i { return addKeyword(k); }

HOUR = k:"hour"i { return addKeyword(k); }

MINUTE = k:"minute"i { return addKeyword(k); }

SECOND = k:"second"i { return addKeyword(k); }

FRACTION = k:"fraction"i { return addKeyword(k); }
...
string_exp
  = s:(double_quoted_string / single_quoted_string) { return addString(s); }
