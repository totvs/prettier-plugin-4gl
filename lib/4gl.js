...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c35 = function(v) { return addBuiltInVar(v); },
      peg$c36 = "arr_count",
      peg$c37 = peg$literalExpectation("arr_count", true),
      peg$c38 = "arr_curr",
      peg$c39 = peg$literalExpectation("arr_curr", true),
      peg$c40 = "errorlog",
      peg$c41 = peg$literalExpectation("errorlog", true),
      peg$c42 = "fgl_keyval",
      peg$c43 = peg$literalExpectation("fgl_keyval", true),
      peg$c44 = "fgl_lastkey",
      peg$c45 = peg$literalExpectation("fgl_lastkey", true),
      peg$c46 = "infield",
      peg$c47 = peg$literalExpectation("infield", true),
      peg$c48 = "int_flag",
      peg$c49 = peg$literalExpectation("int_flag", true),
      peg$c50 = "quit_flag",
      peg$c51 = peg$literalExpectation("quit_flag", true),
      peg$c52 = "num_args",
      peg$c53 = peg$literalExpectation("num_args", true),
      peg$c54 = "scr_line",
      peg$c55 = peg$literalExpectation("scr_line", true),
      peg$c56 = "set_count",
      peg$c57 = peg$literalExpectation("set_count", true),
      peg$c58 = "showhelp",
      peg$c59 = peg$literalExpectation("showhelp", true),
      peg$c60 = "sqlca",
      peg$c61 = peg$literalExpectation("sqlca", true),
      peg$c62 = "sqlcode",
      peg$c63 = peg$literalExpectation("sqlcode", true),
      peg$c64 = "sqlerrd",
      peg$c65 = peg$literalExpectation("sqlerrd", true),
      peg$c66 = "startlog",
      peg$c67 = peg$literalExpectation("startlog", true),
      ...
      peg$c75 = function(id) { return addId(id); },
      peg$c76 = "define",
      peg$c77 = peg$literalExpectation("define", true),
      peg$c78 = function(k) { return addKeyword(k); },
      peg$c79 = "call",
      peg$c80 = peg$literalExpectation("call", true),
      peg$c81 = "display",
      peg$c82 = peg$literalExpectation("display", true),
      peg$c83 = "end",
      peg$c84 = peg$literalExpectation("end", true),
      peg$c85 = "function",
      peg$c86 = peg$literalExpectation("function", true),
      peg$c87 = "globals",
      peg$c88 = peg$literalExpectation("globals", true),
      peg$c89 = "let",
      peg$c90 = peg$literalExpectation("let", true),
      peg$c91 = "prompt",
      peg$c92 = peg$literalExpectation("prompt", true),
      peg$c93 = "main",
      peg$c94 = peg$literalExpectation("main", true),
      peg$c95 = "string",
      peg$c96 = peg$literalExpectation("string", true),
      peg$c97 = "returning",
      peg$c98 = peg$literalExpectation("returning", true),
      peg$c99 = /^[~!@%\^&*-+|\/{}:;<>?#_]/,
      peg$c100 = peg$classExpectation(["~", "!", "@", "%", "^", "&", ["*", "+"], "|", "/", "{", "}", ":", ";", "<", ">", "?", "#", "_"], false, false),
      peg$c101 = function(o) { addOperator(o); },
      peg$c102 = "=",
      ...
      peg$c122 = "array",
      peg$c123 = peg$literalExpectation("array", true),
      peg$c124 = "bigint",
      peg$c125 = peg$literalExpectation("bigint", true),
      peg$c126 = "byte",
      peg$c127 = peg$literalExpectation("byte", true),
      peg$c128 = "char",
      peg$c129 = peg$literalExpectation("CHAR", true),
      peg$c130 = "character",
      peg$c131 = peg$literalExpectation("character", true),
      peg$c132 = "date",
      peg$c133 = peg$literalExpectation("date", true),
      peg$c134 = "datetime",
      peg$c135 = peg$literalExpectation("datetime", true),
      peg$c136 = "dec",
      peg$c137 = peg$literalExpectation("dec", true),
      peg$c138 = "decimal",
      peg$c139 = peg$literalExpectation("decimal", true),
      peg$c140 = "double",
      peg$c141 = peg$literalExpectation("double", true),
      peg$c142 = "precision",
      peg$c143 = peg$literalExpectation("precision", true),
      peg$c144 = "dynamic",
      peg$c145 = peg$literalExpectation("dynamic", true),
      peg$c146 = "float",
      peg$c147 = peg$literalExpectation("float", true),
      peg$c148 = "int",
      peg$c149 = peg$literalExpectation("int", true),
      peg$c150 = "integer",
      peg$c151 = peg$literalExpectation("integer", true),
      peg$c152 = "interval",
      peg$c153 = peg$literalExpectation("interval", true),
      peg$c154 = "like",
      peg$c155 = peg$literalExpectation("like", true),
      peg$c156 = "money",
      peg$c157 = peg$literalExpectation("money", true),
      peg$c158 = "nchar",
      peg$c159 = peg$literalExpectation("nchar", true),
      peg$c160 = "numeric",
      peg$c161 = peg$literalExpectation("numeric", true),
      peg$c162 = "nvarchar",
      peg$c163 = peg$literalExpectation("nvarchar", true),
      peg$c164 = "of",
      peg$c165 = peg$literalExpectation("of", true),
      peg$c166 = "for",
      peg$c167 = peg$literalExpectation("for", true),
      peg$c168 = "real",
      peg$c169 = peg$literalExpectation("real", true),
      peg$c170 = "record",
      peg$c171 = peg$literalExpectation("record", true),
      peg$c172 = "smallfloat",
      peg$c173 = peg$literalExpectation("smallfloat", true),
      peg$c174 = "smallint",
      peg$c175 = peg$literalExpectation("smallint", true),
      peg$c176 = "text",
      peg$c177 = peg$literalExpectation("text", true),
      peg$c178 = "to",
      peg$c179 = peg$literalExpectation("to", true),
      peg$c180 = "varchar",
      peg$c181 = peg$literalExpectation("varchar", true),
      peg$c182 = "year",
      peg$c183 = peg$literalExpectation("year", true),
      peg$c184 = "month",
      peg$c185 = peg$literalExpectation("month", true),
      peg$c186 = "day",
      peg$c187 = peg$literalExpectation("day", true),
      peg$c188 = "hour",
      peg$c189 = peg$literalExpectation("hour", true),
      peg$c190 = "minute",
      peg$c191 = peg$literalExpectation("minute", true),
      peg$c192 = "second",
      peg$c193 = peg$literalExpectation("second", true),
      peg$c194 = "fraction",
      peg$c195 = peg$literalExpectation("fraction", true),
      peg$c196 = function(t) { return addNumber(ConstType.integer, parseInt(text, 10)); },
      peg$c197 = "+",
      peg$c198 = peg$literalExpectation("+", false),
      peg$c199 = "-",
      peg$c200 = peg$literalExpectation("-", false),
      peg$c201 = function(s) { return addString(s); },
      peg$c202 = "\"",
      ...
      peg$c234 = function(s) { return addSpace(s); },
      peg$c235 = "\n",
